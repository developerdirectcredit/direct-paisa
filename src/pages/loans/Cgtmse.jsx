...
/*         Guarantee hero, with the CGTMSE image.                      */
/*  Wizard = the full CGTMSE flow.                                     */
/* ------------------------------------------------------------------ */
...
function Hero({ onStart }) {
  ...
  return (
    <section className="bg-gradient-to-b from-slate-50 to-white">
      <div className="mx-auto max-w-6xl px-5 py-10 lg:py-16">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          {/* Left column — CGTMSE poster image */}
          <div>
            <img
          ...
          {/* Right column — lead card */}
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm lg:p-8">
            <div className="rounded-xl bg-blue-50 px-4 py-3 text-sm text-[#1a3a8f]">
            ...
            <p className="mt-1 text-center text-2xl font-bold">
              Get a collateral-free <span className="text-[#1a3a8f]">MSME loan</span>
            </p>
            ...
            <div className="mt-6 space-y-4">
              ...
              <button
                onClick={handleStart}
                className="flex w-full items-center justify-center gap-2 rounded-lg bg-[#1a3a8f] py-3.5 font-semibold text-white transition hover:bg-[#15306f]"
              >
                Continue <ArrowRight className="h-4 w-4" />
              </button>
