...
// /*  Hero = lead capture (Name + Mobile), with the professional image.  */
// /*  Wizard = the full Professional loan flow.                          */
...
//     }
//     setErrors({});
//     // Eligibility criteria met → show success toast, then success screen.
//     toast.success("Eligibility met! Your loan application has been submitted.", {
//       duration: 4000,
//     });
//     setSubmitted(true);
//   };
...
//               Loans for <span className="text-blue-600">Professionals</span>
//             </h1>
...
//               Funding for your <span className="text-blue-600">practice</span>
//             </p>
